...
export default function Pagina404() {
    return (
        <Container404>
            <Titulos $tituloRoxo className="text">
                404
            </Titulos>
            <Mensagem>Iiih deu ruim... Página não encontrada</Mensagem>
            <Descricao>
                Essa página ainda não foi desenvolvida, vai ficar pra depois ,
                mas faz o seguinte, clica no botão abaixo ai e volte pra home.
            </Descricao>
